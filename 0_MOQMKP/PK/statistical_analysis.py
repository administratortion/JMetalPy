...
if __name__ == '__main__':
    ...
    # avg = compute_mean_indicator(filename='QualityIndicatorSummary.csv', indicator_name='IGD')
    # print(avg)

    # Non-parametric test

    # print('-------- Sign Test --------')
    # print(sign_test(avg[['NSGAII', 'MODE']]))
    # print('-------- Friedman Test --------')
    # print(friedman_test(avg))
    # print('-------- Friedman Aligned Rank Test --------')    # print(friedman_aligned_rank_test(avg))
    # print('-------- Quade Test --------')
